    ...
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between">
                <h5>DATA PENGGUNA</h5>
                <div class="d-flex ">
                    <select name="role" id="roles" class="custom-select mr-2">
                        <option value="" disabled selected hidden>Pilih Role</option>
                        <option value="admin">Admin</option>
                        <option value="user">User</option>
                    </select>
                    <button data-toggle="modal" data-target="#modalTambahData"
                        ...
                        <tbody id="table-user">
                            @foreach ($data as $no => $user)
                                <tr>
                                    ...
                                    <td>
                                        <button data-id="{{ $user->id }}" id="btn-edit"
                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button>
                                        <button data-id="{{ $user->id }}" id="btn-hapus"
...
@section('javascript')
    <script>
        $(document).ready(function() {
            ...
            //role
            $(document).on('change', '#roles', async function() {
                const role = $(this).val();
