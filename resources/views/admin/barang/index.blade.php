                        ...
                        <tbody>
                            @foreach ($barang as $no => $br)
                                <tr>
                                    ...
                                    <td>{{ $br->stok }}</td>
                                    <td>
                                        <button data-id="{{ $br->id }}" id="btn-edit"
                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button>
                                        <button data-id="{{ $br->id }}" id="btn-hapus"
                                            class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                        <button data-id="{{ $br->id }}" id="btn-detail"
                                            class="btn btn-warning btn-sm"><i class="fa fa-info"></i></button>
                                        <a href="/foto-barang/{{ $br->id }}" class="btn btn-info btn-sm"><i
            ...
            <div class="modal-content">
                ...
                <form id="formTambah" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="berat">Berat <span><small
                                        class="form-text text-muted d-inline">(*gram)</small></span></label>
